      ...
      <div className="grid grid-cols-1 lg:grid-cols-[200px_1fr] gap-8 items-end">
        ...
        <div className="relative group mt-12 lg:mt-0">
          <motion.div
            ...
            className="relative h-[300px] sm:h-[400px] md:h-[500px] w-full overflow-hidden rounded-[30px] sm:rounded-[40px]"
          >
            <Image
            ...
            <div className="absolute bottom-20 left-6 sm:bottom-8 sm:left-48 flex flex-col sm:flex-row gap-4 sm:gap-8 md:gap-12 text-white text-sm">
              ...
              <div>
                ...
                <a href="mailto:info@salhurry.in" className="font-medium text-[10px] sm:text-sm hover:text-[#A3E635] transition-colors">info@salhurry.in</a>
              </div>
            </div>
          </motion.div>
